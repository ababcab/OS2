...
#define __K__ (1024)
#define __B__ (1)
#define DISK_MAGNITUDE (DISKMAGN)
#define DISK_SIZE (DISKSIZE * DISK_MAGNITUDE)
...
#define OS2_DISKLOCK_START (OS2_SLEEPLOCK_INIT + 1)
#define OS2_DISKLOCK_END (OS2_DISKLOCK_START + VIRTIO_RAID_DISK_END - 1)

#define OS2_ROWLOCK_START (OS2_DISKLOCK_END + 1)
#define OS2_ROWLOCK_END (OS2_ROWLOCK_START + BLOCKS_IN_DISC - 1)

#define OS2_DISKLOCK(x) (OS2_DISKLOCK_START + x - 1)
#define OS2_ROWLOCK(x) (OS2_ROWLOCK_START + x)
/* Nije greska sto nema -1 ovde^ */